...
PRIVATE            :: integral
INTEGER, PARAMETER :: dpr = SELECTED_REAL_KIND(14) !was (12, 60)
...
REAL (dpr) :: a1 = -4.166666666554424D-02, a2 = 2.430554511376954D-03,  &
...
REAL (dpr), INTENT(IN) :: dk
REAL, INTENT(IN)      :: a, b
REAL, INTENT(OUT)     :: result

!     Local variables

REAL (dpr)  :: xmid, range, x1, x2,                                    &
  x(3) = (/0.238619186083197_dpr, 0.661209386466265_dpr, 0.932469514203152_dpr/), &
  w(3) = (/0.467913934572691_dpr, 0.360761573048139_dpr, 0.171324492379170_dpr/)
INTEGER    :: i
