...
for i in dirlist:
    ...
    conf = conf.iloc[0::10, :] # jump every 10 -- coz recommended time is 0.01*10 sec
    conf = conf[['x','y']]
...
plt.errorbar(x,y,yerr=dev, ecolor='b', capsize=7, mec='blue', color='green', marker='D', linewidth=2, markersize=7)
